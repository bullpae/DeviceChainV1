...
.config(function ($routeProvider) {
  ...
  .when('/device_mana',{ controller: 'DeviceRegCtrl', templateUrl: '/templates/server/device_mana.html' })
  .when('/device_reg',{ controller: 'DeviceRegCtrl', templateUrl: '/templates/server/device_reg.html' })
